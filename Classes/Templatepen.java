...
public class Templatepen extends JFrame implements ActionListener{
    JPanel panel2;
    ...
    public Templatepen(){
        ...
        bg2 = new ImageIcon("Elements/back-to-school-background-with-school-supplies-background-free-photo.jpg");
...
bg1 = new ImageIcon("Elements/pencil.jpg");
b1 = new JButton(bg1);
...
bg2 = new ImageIcon("Elements/pen.jpg");
b2 = new JButton(bg2);
...
bg3 = new ImageIcon("Elements/notebook.jpg");
b3 = new JButton(bg3);
...
bg4 = new ImageIcon("Elements/stapler.jpg");
b4 = new JButton(bg4);
...
bg5 = new ImageIcon("Elements/scale.jpg");
b5 = new JButton(bg5);
...
bg6 = new ImageIcon("Elements/geobox.jpg");
b6 = new JButton(bg6);
...
this.add(panel2);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==b1)
        {
         pFramesp g = new pFramesp();
         this.setVisible(false);
         g.setVisible(true);
        }
        else if(ae.getSource()==b2)
        {
            pFramesp n = new pFramesp();
            this.setVisible(false);
            n.setVisible(true);
        }
           ...
           pFramesp x = new pFramesp();
           this.setVisible(false);
           x.setVisible(true);
        }
        else if(ae.getSource()==b5){
            pFramesp l = new pFramesp();
            this.setVisible(false);
            l.setVisible(true);
         }
         else if(ae.getSource()==b6){
            pFramesp z = new pFramesp();
            this.setVisible(false);
            z.setVisible(true);
         }
         else if(ae.getSource()==b7){
            SelectionR x = new SelectionR();
            this.setVisible(false);
            x.setVisible(true);
         }
