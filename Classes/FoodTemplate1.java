...
public class FoodTemplate1 extends JFrame implements ActionListener {
JPanel panel2;
...
bg1 = new ImageIcon("Elements/Burger1.jpg");
b1 = new JButton(bg1);
...
bg2 = new ImageIcon("Elements/Burger2.jpg");
b2 = new JButton(bg2);
b2.setBounds(200,40,150,150);
b2.setFont(new Font("Arial", Font.BOLD, 16));
b2.setVisible(true);
panel2.add(b2);
bg3 = new ImageIcon("Elements/pizza1.jpg");
b3 = new JButton(bg3);
...
bg4 = new ImageIcon("Elements/pizza2.jpg");
b4 = new JButton(bg4);
...
bg5 = new ImageIcon("Elements/burrito.jpg");
b5 = new JButton(bg5);
...
bg6 = new ImageIcon("Elements/ramen.jpg");
b6= new JButton(bg6);
