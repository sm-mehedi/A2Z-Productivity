...
public class FoodTemplate2 extends JFrame implements ActionListener {
JPanel panel2;
...
bg1 = new ImageIcon("Elements/Fish.jpg");
b1 = new JButton(bg1);
...
bg2 = new ImageIcon("Elements/dal.jpg");
b2 = new JButton(bg2);
b2.setBounds(200,40,150,150);
b2.setFont(new Font("Arial", Font.BOLD, 16));
b2.setVisible(true);
panel2.add(b2);
bg3 = new ImageIcon("Elements/puri.jpg");
b3 = new JButton(bg3);
...
bg4 = new ImageIcon("Elements/Singara.jpg");
b4 = new JButton(bg4);
...
bg5 = new ImageIcon("Elements/samusa.jpg");
b5 = new JButton(bg5);
...
bg6 = new ImageIcon("Elements/rice.jpg");
b6= new JButton(bg6);
...
bg2 = new ImageIcon("Elements/DesiFoodBanner.jpg");
...
label4 = new JLabel("Hilsha Fish");
label4.setVisible(true);
label4.setForeground(Color.black);
label4.setBounds(30, 180, 100, 50);
label4.setLayout(null);

label5 = new JLabel("Puri");
label5.setVisible(true);
label5.setForeground(Color.black);
label5.setBounds(440, 180, 100, 50);
label5.setLayout(null);

label6 = new JLabel("Dal");
label6.setVisible(true);
label6.setForeground(Color.black);
label6.setBounds(260, 180, 150, 50);
label6.setLayout(null);

label7 = new JLabel("Singara");
...
label8 = new JLabel("Samucha");
label8.setVisible(true);
label8.setForeground(Color.black);
label8.setBounds(235, 400, 100, 50);
label8.setLayout(null);

label9 = new JLabel("Rice");
label9.setVisible(true);
label9.setForeground(Color.black);
label9.setBounds(430, 400, 100, 50);
