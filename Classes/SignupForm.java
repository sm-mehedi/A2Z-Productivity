...
public class SignupForm extends JFrame implements ActionListener {
    ...
    public SignupForm(){
        ...
        bg2 = new ImageIcon("Elements/178442-extra-large.png");
        label2 = new JLabel(bg2);
        label2.setVisible(true);
        label2.setBounds(400, 0, 350, 500);
        label2.setLayout(null);

        bg2 = new ImageIcon("Elements/A2Z (1) (1).png");
            ...
            if(ae.getSource()==b1)
			{
                if(ae.getSource() == b1)
                {
                    ...
                    else
                    {
                        try 
                        {
                            File file = new File("D:\\A2Z Productivity\\Data\\user_signup.txt");
                            if (!file.exists()) 
                            {
                                file.createNewFile();
                            }
                            ...
                            pw.println("A2Z USER SIGNUP DATA");
                            pw.println("User Username   : " + username);
