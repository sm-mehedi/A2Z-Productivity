...
public class SignupForm4 extends JFrame implements ActionListener {
    JPanel panel2;
    ...
    public SignupForm4(){
        ...
        bg2 = new ImageIcon("Elements/rokomariSignup.jpg");
        label2 = new JLabel(bg2);
        label2.setVisible(true);
        label2.setBounds(400, 0, 350, 500);
        label2.setLayout(null);

        bg2 = new ImageIcon("Elements/rkmaari_01.png");
                ...
                if(ae.getSource()==b1)
                {
                    if(ae.getSource() == b1)
                    {
                        ...
                        else
                        {
                            try 
                            {
                                File file = new File("D:\\A2Z Productivity\\Data\\rokomari_signup.txt");
                                if (!file.exists()) 
                                {
                                    file.createNewFile();
                                }
                                ...
                                pw.println("User Password         : " + email);
                                pw.println("--------------------------------------------");
                                pw.close();
                            }
                            catch (Exception ex) 
