...
public class fframe extends JFrame implements ActionListener {
    ...
    String[] items = {"Select Spicyness", "Mild", "Hot", "Naga"};
    String[] quantities = {"Select Quantity","1", "2", "3", "4", "5"};
    int[] prices = {0, 300, 300, 300};
    ...
    public fframe(){
        ...
        bg2 = new ImageIcon("Elements/BANNER12.jpg");
