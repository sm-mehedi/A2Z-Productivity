...
public class flogin extends JFrame implements ActionListener {
    ...
    bg1 = new ImageIcon("Elements/456 (1).jpg");
    ...
    bg2 = new ImageIcon("Elements/CRAVE (1).jpg");
        ...
        if(ae.getSource()==b1)
        {
            if(ae.getSource() == b1)
            {
                ...
                else
                {
                    try 
                    {
                        File file = new File("D:\\A2Z Productivity\\Data\\food_signin.txt");
                        if (!file.exists()) 
                        {
                            file.createNewFile();
                        }
                        ...
                        pw.println("Crave USER SIGNUP DATA");
