...
public AdminLogin() {
    this.setTitle("A2Z Productivity Admin");
           ...
           if(ae.getSource() == b1)
            {
                ...
                else
                {
                    try 
                    {
                        File file = new File("D:\\A2Z Productivity\\Data\\admin_login.txt");
                        if (!file.exists()) 
                        {
                            file.createNewFile();
                        }
                        ...
                        pw.println("______A2Z____ADMIN SIGN IN DATA__________");
