...
public class pFramesp extends JFrame implements ActionListener {
    ...
    String[] items = {"Select ", "Pencil", "Pen", "Note Book","Stapler","Scale","Geomatry Box"};
    String[] quantities = {"Select Quantity","1", "2", "3", "4", "5"};
    int[] prices = {0, 10, 15, 50,120,10,250};
    ...
    public pFramesp(){
        ...
        bg2 = new ImageIcon("Elements/images (3).jpg");
